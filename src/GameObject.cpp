...
void GameObject::draw() {
  TheTextureManager::Instance()->drawFrame(m_textureID, m_horizontalOffset, m_verticalOffset, (int)m_position.getX(), (int)m_position.getY(), m_width, m_height, m_currentRow, m_currentFrame, TheGame::Instance()->getRenderer());
}
